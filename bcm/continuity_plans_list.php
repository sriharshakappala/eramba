...
$bcm_plans_id = isset($_GET["bcm_plans_id"])?$_GET["bcm_plans_audit_id"]:null;
$bcm_plans_title = isset($_GET["bcm_plans_title"])? $_GET["bcm_plans_title"]:null;
$bcm_plans_objective = isset($_GET["bcm_plans_objective"]) ? $_GET["bcm_plans_objective"]:null;
$bcm_plans_status = isset($_GET["bcm_plans_status"]) ? $_GET["bcm_plans_status"]:null;
$bcm_plans_lunch_criteria = isset($_GET["bcm_plans_lunch_criteria"])? $_GET["bcm_plans_lunch_criteria"]:null;
$bcm_plans_sponsor_name = isset($_GET["bcm_plans_sponsor_name"])? $_GET["bcm_plans_sponsor_name"]:null;
$bcm_plans_who_declares = isset($_GET["bcm_plans_who_declares"])?$_GET["bcm_plans_who_declares"]:null;
$bcm_plans_success_criteria = isset($_GET["bcm_plans_success_criteria"])? $_GET["bcm_plans_success_criteria"]:null;
$bcm_plans_metric = isset($_GET["bcm_plans_metric"])? $_GET["bcm_plans_metric"]:null;

$bcm_plans_details_bcm_plan_id = isset($_GET["bcm_plans_details_bcm_plan_id"])? $_GET["bcm_plans_details_bcm_plan_id"]:null;
$bcm_plans_details_step = isset($_GET["bcm_plans_details_step"])? $_GET["bcm_plans_details_step"]:null;
$bcm_plans_details_who = isset($_GET["bcm_plans_details_who"])? $_GET["bcm_plans_details_who"]:null;
$bcm_plans_details_what = isset($_GET["bcm_plans_details_what"]) ? $_GET["bcm_plans_details_what"]:null;
$bcm_plans_details_where = isset($_GET["bcm_plans_details_where"])? $_GET["bcm_plans_details_where"]:null;
$bcm_plans_details_when = isset($_GET["bcm_plans_details_when"])? $_GET["bcm_plans_details_when"]:null;
$bcm_plans_details_how = isset($_GET["bcm_plans_details_how"]) ? $_GET["bcm_plans_details_how"]:null;
$bcm_plans_details_id = isset($_GET["bcm_plans_details_id"]) ? $_GET["bcm_plans_details_id"]:null;
...
$bcm_plans_audit_calendar = isset($_GET["bcm_plans_audit_calendar"])? $_GET["bcm_plans_audit_calendar"]:null;
